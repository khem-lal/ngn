...
public class Log
{
  ...
  private static void doLog(int level, String logString, Throwable t)
  {
	...
	long t0 = System.currentTimeMillis();
      try
      {
        ...
        ctx.rebind("logging-context", "G2CLoggingContext");
      } catch(Exception e2) 
      {
  ...
  private static String getCatName(Object logFor)
  {
    ...
    if(!className.startsWith("G2C"))
    {
      className = "G2C" + "." + className;
    }
...
public static void resetLoggingLevel()
  {
		...
		Category cat = Category.getInstance("G2C");
